...
public class Board extends World
{
    ...
    {    
        ...
        bgMusic = new GreenfootSound("pvz_daytimeFrontyard.mp3");
    ...
    public void lostBoard() 
    {
        ...
        if (tries == 0) {
            ...
            bgMusic.stop();
            Greenfoot.playSound("losemusic.mp3");
            gameOver("Game Over");
        }
        else {
            Greenfoot.delay(100);
    ...
    /**
     * Whatever methods are called inside here will execute
     * when the start/play button is clicked
     */
    public void started()
    {
        System.out.println("Execution has restarted.\nNow resuming music.");
        bgMusic.playLoop();
    }
    ...
    public void stopped()
    {
        System.out.println("Execution has stopped.\nNow pausing any music playing.");
        bgMusic.pause();
    }
}
